...
Veuillez ajouter une déclaration concernant l'utilisation de l'IA dans votre projet dans le fichier `exercices/tp1/tp1.md`. 
...
> **L'utilisation d'outils d'IA est autorisée** (elle n'est pas interdite).
> Vous devez simplement **déclarer de façon transparente** toute utilisation de l'IA, même partielle, conformément aux consignes ci-dessus.
