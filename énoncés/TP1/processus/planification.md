...
`exercices/tp1/tp1.md`.

### Consignes pour les captures d’écran

- Toutes les captures d’écran doivent être **commitées dans le dépôt** (pas de lien externe).
- Placez toutes les images dans le dossier : **`exercices/tp1/images/`**
- Référencez chaque image directement dans `exercices/tp1/tp1.md` avec un lien relatif Markdown :
...
- Nommez vos fichiers de façon claire : tp1-project.png, tp1-milestone.png, tp1-issue-1.png, tp1-pr-1.png, tp1-commit-tree.png, etc.
...
- **Traçabilité** : les issues du TP1 apparaissent dans le Project.
...
- **Milestone TP1 existant** : titre clair et description (si pertinente).
- **Date de fin** correspondant à l’échéance du TP.
- **Couverture** : les issues du TP1 sont associées à ce milestone.
