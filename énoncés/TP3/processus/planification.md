...
`exercices/tp3/tp3.md`.

### Consignes pour les captures d’écran

- Toutes les captures d’écran doivent être **commitées dans le dépôt** (pas de lien externe).
- Placez toutes les images dans le dossier : **`exercices/tp3/images/`**
- Référencez chaque image directement dans `exercices/tp3/tp3.md` avec un lien relatif Markdown :
...
- Nommez vos fichiers de façon claire : tp3-project.png, tp3-milestone.png, tp3-issue-1.png, tp3-pr-1.png, tp3-commit-tree.png, etc.
...
- **Traçabilité** : les issues du TP3 apparaissent dans le Project.
...
- **Milestone TP3 existant** : titre clair et description (si pertinente).
- **Date de fin** correspondant à l’échéance du TP.
- **Couverture** : les issues du TP3 sont associées à ce milestone.
